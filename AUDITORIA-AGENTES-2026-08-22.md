...
|---|------|---------|---------|
| 1 | C2 — validar args nos 7 scripts (regex UUID/enum) | 30 min | alto |
| 2 | C3 — super_admin na identidade + contexto | 1-2 h | alto |
| 3 | A1 — dedup de incidentes (Argos + Gavião, janela 12h) | 1-2 h | alto |
| 4 | Prompts otimizados (seção 3) nos SKILL-*.md | 1 h | médio |
| 5 | A3 — cache com umask/dir por usuário | 15 min | médio |
| 6 | A4/A6/M1/M2 — correções pontuais | 30 min | médio |
| 7 | C1 — mover autorização para o backend (endpoint Hermes) | dias | alto (estrutural) |
| 8 | M6 — testes de argos/iris/relatorio | 2 h | médio |

C1 é a mudança estrutural: enquanto a autorização morar no prompt, todo o
resto é mitigação. Planeje como próxima fase.
